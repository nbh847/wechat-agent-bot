...
模板见 `docs/operations/com.example.wechat-agent-bot.plist.example`。安装时应将 `example` 替换为自己的反向域名标识，建议目标为：

```text
~/Library/LaunchAgents/com.example.wechat-agent-bot.plist
```
